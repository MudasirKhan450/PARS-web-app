...
<div role="status" className="p-4 h-[70vh] w-[100%]  border-b-[12px] border-black rounded-sm shadow-sm animate-pulse md:p-6 dark:border-gray-700">
<div className="flex items-center mb-3">
    ...
    <div className="flex h-[80%]   items-center justify-center  mb-4 bg-gray-400 rounded-sm dark:bg-gray-700">
        <svg className="w-10   text-gray-400 dark:text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
